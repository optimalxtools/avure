...
const CAPTURE_SECTIONS: CaptureSection[] = [
  {
    title: "Field harvest log",
    description:
      "Record the daily harvest summary that will power the overview and breakdown dashboards.",
    fields: [
      {
        id: "harvest-date",
        label: "Harvest date",
        placeholder: "Select the harvest date",
        type: "date",
      },
      {
        id: "harvest-block",
        label: "Block",
        placeholder: "Choose the block harvested",
        type: "select",
        options: ["Block placeholder A", "Block placeholder B"],
      },
      {
        id: "harvest-variety",
        label: "Variety",
        placeholder: "Select the variety harvested",
        type: "select",
        options: ["Variety placeholder", "All varieties"],
      },
      {
        id: "harvest-quantity",
        label: "Quantity harvested",
        placeholder: "Enter kilograms harvested",
        type: "number",
      },
      {
        id: "harvest-notes",
        label: "Operational notes",
        placeholder: "Observations we should highlight later",
        type: "textarea",
      },
    ],
    actionLabel: "Log harvest (placeholder)",
  },
  {
    title: "Labour allocation",
    description:
      "Future capture area for teams, hours and labour costs linked to harvest operations.",
    fields: [
      {
        id: "labour-team",
        label: "Team or crew",
        placeholder: "Identify the crew working on this harvest",
      },
      {
        id: "labour-hours",
        label: "Total hours",
      ...
      },
      {
        id: "labour-cost",
        label: "Labour cost",
        placeholder: "Projected labour spend for this activity",
        type: "number",
      },
      {
        id: "labour-notes",
        label: "Comments",
        placeholder: "Important labour considerations to monitor",
        type: "textarea",
      },
    ],
  },
  {
    ...
    description:
      "Capture field-level quality indicators that feed into the packhouse quality checks.",
    fields: [
      {
        id: "quality-sample",
        label: "Sample reference",
        placeholder: "Assign a sample or lot reference",
      },
      {
        id: "quality-grade",
        label: "Target grade",
        placeholder: "Select the intended grade",
        type: "select",
        options: ["Grade placeholder", "Premium", "Utility"],
      },
      {
        id: "quality-issues",
        label: "Issues observed",
        placeholder: "List pest, disease or weather impacts",
        type: "textarea",
      },
    ],
  },
...
const CAPTURE_HELPER_CARD = (
  <Card className="border-dashed border-muted/50 bg-muted/20">
    <CardHeader>
      <CardTitle>Harvest capture planning</CardTitle>
      <CardDescription>
        Use this view to review the information we intend to collect before wiring it into the
        analytics flows.
      </CardDescription>
    </CardHeader>
    <CardContent>
      <p className="text-sm text-muted-foreground">
        Once capture is live this area will feed the harvest overview, breakdown and labour
        analytics with structured, validated inputs.
      </p>
    </CardContent>
  </Card>
)
...
export default function Page() {
  ...
  resetSeason,
    ...
    pageKey: "filters:harvest:data-acquisition",
