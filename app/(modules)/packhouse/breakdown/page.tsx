...
import { MetricsPage, type CategoryKey } from "./components/pages/metrics"
...
export default function Page() {
  ...
  const {
    ...
    pageKey: "filters:packhouse:breakdown",
    seasons,
    autoSelectFirstVariety: true,
    autoSelectFirstSeason: true,
  })

  const category: CategoryKey = "class"
  ...
  const prevSeasonAvailable = previousSeasonRecords.length > 0
      ...
      <header className="flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
        <div className="flex items-center justify-between w-full px-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <AIButton currentPage="Packhouse - Breakdown" />
          </div>
        </div>
      </header>
