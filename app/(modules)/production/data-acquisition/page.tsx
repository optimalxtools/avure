...
import { Database, Lock, Unlock, RotateCcw } from "lucide-react"
...
const CAPTURE_SECTIONS: CaptureSection[] = [
  {
    ...
    description:
      "Outline planned planting events that will later sync with production planning views.",
    fields: [
      {
        id: "planting-window",
        label: "Planting window",
        placeholder: "e.g. 04 Mar – 08 Mar",
      },
      {
        id: "planting-variety",
        label: "Variety",
        placeholder: "Select the planned variety",
        type: "select",
        options: ["Variety placeholder", "New cultivar"],
      },
      {
        id: "planting-area",
        label: "Area or beds",
        placeholder: "Specify hectares or bed count",
      },
      {
        id: "planting-notes",
        label: "Instructions",
        placeholder: "Key agronomy instructions for the crew",
        type: "textarea",
      },
    ],
    actionLabel: "Schedule planting (placeholder)",
  },
  {
    title: "Input applications",
    description:
      "Placeholder for fertiliser and chemical applications used by benchmarking and compliance.",
    fields: [
      {
        id: "application-date",
        label: "Application date",
        placeholder: "Choose the intended date",
        type: "date",
      },
      {
        id: "application-type",
        label: "Application type",
        placeholder: "Select fertiliser, spray, etc.",
        type: "select",
        options: ["Fertiliser", "Spray", "Irrigation"],
      },
      {
        id: "application-product",
        label: "Product",
        placeholder: "Capture product or blend name",
      },
      {
        id: "application-quantity",
        label: "Quantity",
        placeholder: "Record units applied",
        type: "number",
      },
      {
        id: "application-notes",
        label: "Notes",
        placeholder: "Special handling, PHI, or weather considerations",
        type: "textarea",
      },
    ],
  },
  {
    title: "Crop performance observations",
    description: "Collect scouting insights that inform production forecasting and alerts.",
    fields: [
      {
        id: "observation-date",
        label: "Observation date",
        placeholder: "Date the observation was captured",
        type: "date",
      },
      {
        id: "growth-stage",
        label: "Growth stage",
        placeholder: "e.g. Vegetative, Flowering, Harvest-ready",
      },
      {
        id: "observation-indicator",
        label: "Indicator measured",
        placeholder: "Describe the metric or symptom",
      },
      {
        id: "observation-details",
        label: "Details",
        placeholder: "Context to support alerts and decisions",
        type: "textarea",
      },
    ],
  },
...
const CAPTURE_HELPER_CARD = (
  <Card className="border-dashed border-muted/50 bg-muted/20">
    <CardHeader>
      <CardTitle>Production capture planning</CardTitle>
      <CardDescription>
        These placeholders mirror the inputs the production module expects once integrations are
        ready.
      </CardDescription>
    </CardHeader>
    <CardContent>
      <p className="text-sm text-muted-foreground">
        Reviewing the structure now helps align agronomy, compliance and forecasting workflows
        before we connect real data sources.
      </p>
    </CardContent>
  </Card>
)
...
export default function Page() {
  ...
  resetSeason,
    ...
    pageKey: "filters:production:data-acquisition",
